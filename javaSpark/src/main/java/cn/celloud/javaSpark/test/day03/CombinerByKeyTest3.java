...
public class CombinerByKeyTest3 {
	@SuppressWarnings("unchecked")
	public static void main(String[] args) {
		SparkConf conf = new SparkConf().setAppName("combinerByKey").setMaster("local");
		...
		Function2<String, String, String> mergeCombiners = new Function2<String, String, String>() {
			...
			public String call(String v1, String v2) throws Exception {
				return v1 + " :mergeCombiners is" + v2;
			}
		};
		 ...
		 * result is :
		 * [
		 * 	(class5,50:createCombiner), 
		 * 	(class3,1:createCombiner:mergeValue is 721), 
		 *	(class1,80:createCombiner:mergeValue is 90:mergeValue is 10), 
		 * 	(class4,23:createCombiner:mergeValue is 20), 
		 * 	(class2,75:createCombiner:mergeValue is 34:mergeValue is 67:mergeValue is 30:mergeValue is 65)
		 * ]
		 */
